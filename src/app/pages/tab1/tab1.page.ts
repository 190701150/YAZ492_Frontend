...
export class Tab1Page implements OnInit{
  ...
  constructor(private httpClient: HttpClient, private readonly alertController: AlertController, private readonly activatedRoute: ActivatedRoute, private favoritesService: FavoritesService) {}
  ngOnInit(): void {
    this.getCars()
    this.getModels()
    this.getColors()
